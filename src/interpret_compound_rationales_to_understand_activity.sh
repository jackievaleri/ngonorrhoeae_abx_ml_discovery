...
chemprop_interpret --data_path "$DATA_PATH"molport_val1_mols_for_interpretation.csv --checkpoint_dir $MODEL_PATH --property_id 1 --smiles_column SMILES --max_atoms 10 --min_atoms 8 --prop_delta 0.1 --features_generator rdkit_2d_normalized --no_features_scaling > "$OUT_PATH"testtesttest.txt
