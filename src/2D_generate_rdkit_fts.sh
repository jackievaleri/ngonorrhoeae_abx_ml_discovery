...
#
# Datasets Featurized
# - Dataset 0: PK screen (11_15_2021)  -- *feeds the Round 0 PK-only GNN, which is used in
#   the manuscript only to generate Figure 2E; otherwise left for interested readers*
...
# PK screen only
# NOTE: Features for the Round 0 (PK-only) GNN — used in the manuscript only to generate Figure 2E; otherwise left for interested readers.
