...
#
# Datasets Featurized
# - Dataset 0: PK screen (11_15_2021)  -- *feeds the Round 0 PK-only GNN, which is not used in
#   the manuscript; otherwise left for interested readers*
...
# PK screen only
# NOTE: Features for the Round 0 (PK-only) GNN — not used in the manuscript; otherwise left for interested readers.
